...
class ESP32Controller:
    """
    Controlador para ESP32-CAM y Sensor Ultrasónico HC-SR04.
    Provee telemetría de presencia y capturas de seguridad.
    """
    def __init__(self):
        ...
        self.distance_cm = 45.0 # En rango de proximidad del kiosco (<100cm)
